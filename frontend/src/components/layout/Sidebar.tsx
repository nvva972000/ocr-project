...
import { SidebarContainer, SidebarSection, NavList, NavItem, NavLink, NavButton, MenuContent, ExpandIcon, SubNavList, ComingSoonBadge, staticMenuItems } from './Sidebar.styles';
