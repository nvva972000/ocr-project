...
import { HeaderContainer, HeaderContent, LogoHeader, UserAvatar, UserGroup, UserInfo } from './Header';
            ...
            <UserInfo>
                <UserGroup>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'end', flexDirection: 'column' }}>
                        <span style={{ fontSize: '14px', fontWeight: 600, lineHeight: 1.2, color: '#ffffff' }}>{localStorage.getItem('username')}</span>
                    </div>
